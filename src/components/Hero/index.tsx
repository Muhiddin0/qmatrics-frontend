                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  >
                    <Link
                      ...
                      className="glow-on-hover flex items-center gap-3 rounded-sm px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out"
                    >
                      <MdOutlineCall size={22} /> Contact
                    </Link>
                  </AnimatedComponent>
                  <AnimatedComponent
